<h2><a href="https://leetcode.com/problems/k-th-smallest-remaining-even-integer-in-subarray-queries">K-th Smallest Remaining Even Integer in Subarray Queries</a></h2> <img src='https://img.shields.io/badge/Difficulty-Hard-red' alt='Difficulty: Hard' /><hr><p>You are given an integer array <code>nums</code> where <code>nums</code> is <strong>strictly increasing</strong>.</p>
